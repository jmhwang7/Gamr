    ...
    (
        ...
        '.($use_games ? 'if(field_id = '.FIELD_LOL_ROLE.', if('.$userFieldsQuery[FIELD_LOL_ROLE].', 0, 1), 
            if(field_id = '.FIELD_LOL_RANK.', (1-ABS(field_value - '.$userFields[FIELD_LOL_RANK].')*0.5), 
                if(field_id = '.FIELD_LOL_GAMEMODE.', if('.$userFieldsQuery[FIELD_LOL_GAMEMODE].', 1, 0),
                    if(field_id = '.FIELD_LOL_SERVER.', if('.$userFieldsQuery[FIELD_LOL_SERVER].', 1, 0), NULL)
                )
            )
        ...
        (SELECT field_value FROM user_game_fields WHERE user_id=id AND field_id = '.FIELD_LOL_SERVER.') AS server,
