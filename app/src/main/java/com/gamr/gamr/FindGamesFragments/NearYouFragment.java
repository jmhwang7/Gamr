...
/**
 * Fragment class that deals with finding people near you
 */
public class NearYouFragment extends Fragment {
     ...
     * number.
     */
    public static NearYouFragment newInstance(int sectionNumber) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.near_you_fragment, container, false);
        return rootView;
    }
}
